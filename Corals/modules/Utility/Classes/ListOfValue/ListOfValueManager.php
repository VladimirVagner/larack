...
class ListOfValueManager
{
    ...
    {
        $listOfValue = $this->getLOVByCode($code, $parentCode, $attribute, $default, true);
     ...
     */
    public function getLOVByCode($code, $parentCode = null, $attribute = 'label', $default = null, $object = false)
    {
